...
from dsp_core.trasmitter_qam import TransmitterQam16
...
def main():
    ...
    tx = TransmitterQam16(config)
    N = 100  # symbols at baud rate

    tx_waveform, tx_analog, i_bit_pairs, q_bit_pairs = tx.generate_signal(os_factor, N, B=batch_size)
